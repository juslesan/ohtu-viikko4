...
public class Stepdefs {
    ...
    @When("^unexisting username \"([^\"]*)\" and password \"([^\"]*)\" are given$")
    public void unexisting_username_and_password_are_given(String username, String password) throws Throwable {
        // Write code here that turns the phrase above into concrete actions
        logInWith(username, password);
    }
